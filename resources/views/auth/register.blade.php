...
<div class="flex justify-center">
    <div class="w-4/12 bg-white p-6 rounded-lg">
       <form action="{{ route('register') }}" method="post">
            ...
            <div class="mb-4">
                <label for="password_confirmation" class="sr-only">Verify Password</label>
            ...
            <div>
                <button type="submit" class="bg-blue-500 text-white px-4 py-3 rounded front-medium w-full">
                    Register
                </button>
            </div>
